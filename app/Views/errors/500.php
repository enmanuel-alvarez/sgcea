...
<body class="h-full font-sans flex items-center justify-center p-4">
    <div class="max-w-md w-full text-center space-y-6">
        <div class="inline-flex items-center justify-center w-24 h-24 rounded-full bg-red-500/10 text-red-500 border border-red-500/20 mb-2">
            <i class="bi bi-exclamation-octagon text-5xl"></i>
        </div>
        <h1 class="text-6xl font-extrabold text-white tracking-tight">500</h1>
        <h2 class="text-xl font-bold text-slate-200">Error Interno del Servidor</h2>
        <p class="text-sm text-slate-400">Ha ocurrido un problema inesperado al procesar la solicitud. Por favor contacte al soporte técnico.</p>
        <div>
