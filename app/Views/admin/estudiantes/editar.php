<?php
/**
 * Vista: Admin - Editar Estudiante (Tailwind CSS v3)
 */
...
<div class="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b border-slate-200 dark:border-slate-800 pb-5">
    <div>
        <h1 class="text-2xl font-extrabold text-slate-900 dark:text-white tracking-tight">Editar Estudiante</h1>
        <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Actualice los datos personales y académicos del estudiante.</p>
    </div>
    <div>
...
<form method="POST" action="<?= url('/admin/estudiantes/actualizar/' . $estudiante['id']) ?>" class="space-y-8">
    ...
    <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200/80 dark:border-slate-700/80 shadow-sm p-6 sm:p-8 space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
            <div>
                ...
                <input type="text" id="cedula" name="cedula" value="<?= htmlspecialchars($estudiante['cedula'] ?? '') ?>" required maxlength="20"
            ...
            <div>
                ...
                <input type="text" id="nombres" name="nombres" value="<?= htmlspecialchars($estudiante['nombres'] ?? '') ?>" required maxlength="100"
                       class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm">
            </div>
            ...
            <div>
                ...
                <input type="text" id="apellidos" name="apellidos" value="<?= htmlspecialchars($estudiante['apellidos'] ?? '') ?>" required maxlength="100"
                       class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm">
            </div>
            ...
            <div>
                ...
                <input type="date" id="fecha_nacimiento" name="fecha_nacimiento" value="<?= htmlspecialchars($estudiante['fecha_nacimiento'] ?? '') ?>" required
                       class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm">
            </div>
            ...
            <div>
                ...
                <input type="email" id="correo" name="correo" value="<?= htmlspecialchars($estudiante['correo'] ?? $estudiante['email'] ?? '') ?>" maxlength="100"
                       class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm">
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
                ...
                <input type="text" id="direccion" name="direccion" value="<?= htmlspecialchars($estudiante['direccion'] ?? '') ?>" maxlength="200"
                       class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm">
            </div>
            ...
            <div>
                ...
                <input type="tel" id="telefono" name="telefono" value="<?= htmlspecialchars($estudiante['telefono'] ?? '') ?>" maxlength="20"
                       class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm">
            </div>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200/80 dark:border-slate-700/80 shadow-sm p-6 sm:p-8 space-y-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
            <div>
                ...
                <input type="text" id="nombre_representante" name="nombre_representante" value="<?= htmlspecialchars($estudiante['nombre_representante'] ?? '') ?>" maxlength="100"
                       class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm">
            </div>
            ...
            <div>
                ...
                <input type="tel" id="telefono_representante" name="telefono_representante" value="<?= htmlspecialchars($estudiante['telefono_representante'] ?? '') ?>" maxlength="20"
                       class="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-900 border border-slate-300 dark:border-slate-700 rounded-xl text-slate-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm">
            </div>
        </div>
    </div>
