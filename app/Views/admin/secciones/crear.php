...
<div class="container-fluid py-4">
    <div class="row mb-3"><div class="col-12"><h2><i class="bi bi-plus-circle me-2"></i>Nueva Sección</h2></div></div>
    ...
    <form method="POST" action="?route=admin/secciones/guardar">
        ...
        <div class="d-flex justify-content-end gap-2">
            ...
            <button type="submit" class="btn btn-primary"><i class="bi bi-save me-1"></i>Guardar Sección</button>
        </div>
    </form>
</div>
