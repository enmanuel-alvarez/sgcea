<?php
/**
 * Vista: Docente - Gestión de Calificaciones (Tailwind CSS v3)
 */
...
<div class="mb-6 flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b border-slate-200 dark:border-slate-800 pb-5">
    <div>
        <h1 class="text-2xl font-extrabold text-slate-900 dark:text-white tracking-tight">Gestión de Calificaciones</h1>
        <p class="text-sm text-slate-500 dark:text-slate-400 mt-1">Seleccione una asignatura asignada para registrar y editar notas.</p>
    </div>
</div>
        ...
        <table id="tablaAsignaciones" class="w-full text-left border-collapse text-sm">
            ...
            <tbody class="divide-y divide-slate-100 dark:divide-slate-700/50">
                ...
                <tr class="hover:bg-slate-50 dark:hover:bg-slate-700/30 transition-colors">
                    ...
                    <td>
                        <a href="<?= url('/docente/calificaciones/registrar/' . $asn['id']) ?>" class="inline-flex items-center space-x-1 px-3 py-1.5 bg-blue-600 hover:bg-blue-500 text-white font-semibold rounded-lg text-xs shadow-sm transition-colors">
